    ...
    <div id="wrapper">
     ...
     <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
       ...
       <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
         ...
         <div class="sidebar-brand-text mx-3">RESTAURANTE<sup>INC</sup></div>
       </a>
             ...
             <div class="col-xl-12 col-lg-8">
               <div class="card shadow mb-8">
                 ...
                 <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <!--<h6 class="m-0 font-weight-bold text-primary">aqui contenido</h6>-->
                   <div class="dropdown no-arrow">
                     <a class="dropdown-toggle" href="#"  id="dropdownMenuLink" aria-haspopup="true" aria-expanded="false">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\restaurante\resources\views/plantilla.blade.php ENDPATH**/ ?>